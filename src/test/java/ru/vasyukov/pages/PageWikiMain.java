...
public class PageWikiMain extends BasePageObject {
    ...
    private final String TITLE_CARD =
    ...
    @Step("Swipe до title {title} и клик")
    public PageWikiMain swipeUpToTitleAndClick(String title) {
        swipeUpToFindElementAndClick(templateByText(TITLE_CARD, title), 10, "title '" + title + "'");
        return this;
    }
